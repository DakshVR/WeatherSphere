...
import edu.oregonstate.cs492.assignment4.MainNavGraphDirections
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Call addCities after initializing ViewModel
    ...
    private fun fetchWeatherForCity(cityName: String) {
        ...
        citySearchedViewModel.addSearchedCity(cityName) // Add the searched city
        ...
        citySearchedViewModel.cities.observe(this, Observer { cities ->
            ...
            sortedCitiesList.forEach { city ->
                subMenu?.add(city.name)?.setOnMenuItemClickListener { menuItem ->
                    ...
                    citySearchedViewModel.updateLastViewed(city.name) // Update last viewed timestamp
